        ...
        <div className="flex  flex-col items-center overflow-auto h-[88.5vh] text-center space-y-4 px-6 justify-between pb-2 sm:pb-6">
            <div className='w-full   ' >
                ...
                <div className='flex flex-col w-full   gap-3  ' >
                    <button className='bg-purple-900 text-white      p-2.5 rounded-2xl'  >Book New Service</button>
                    <button className='text-red-600  font-semibold '    > Cancel Booking</button>
